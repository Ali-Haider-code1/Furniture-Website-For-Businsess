...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if (empty($errors)) {
		$sql = "INSERT INTO contactus (fname, lname, email, message) VALUES ('$fname', '$lname', '$email', '$message')";
...
<script>
	...
	if (!empty($successMessage)) {
		echo "showAlert('$successMessage', 'success');";
	}
	?>
	<?php
	if (!empty($errorMessage)) {
		echo "showAlert('$errorMessage', 'error');";
	}
	?>
</script>
